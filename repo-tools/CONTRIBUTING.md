<img src="../docs/assets/images/openair-logo.png" alt="Logo" align="right" height="76"/>

# Contributing

**Any contribution helps our team and make OpenAir Cyan better for the entire community!**

Everybody is welcome and invited to contribute to the OpenAir Cyan Project by:

* Testing newly released features and reporting issues.
* Providing Pull Requests (Features, Proof of Concepts, Language files or Fixes)
* Contributing missing documentation for features and devices in our [documentation](https://openair-collective.github.io/openair-cyan/)
...
3. Questions of type "How do I..." or "Can you please help me with..." or "Can OpenAir Cyan do..." WILL NOT be handled here. Such questions should be directed at a discussion forum or to the OpenAir Cyan Support Chat. All issues of this type will be closed with a simple reference to this contributing policy.
...
* Fork the OpenAir Cyan Repository [git repository](https://github.com/openair-collective/openair-cyan/).
* Write/Change the code in your Fork for a new feature, bug fix, new sensor, optimization, etc.
* Ensure tests work.
* Create a Pull Request against the [**development**](https://github.com/openair-collective/openair-cyan/tree/dev) branch of OpenAir Cyan.
