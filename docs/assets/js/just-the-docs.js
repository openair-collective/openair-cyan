...
function initSearch() {
  ...
  request.open('GET', '{{ "/openair-cyan/assets/js/search-data.json" | absolute_url }}', true);
...
jtd.setTheme = function(theme) {
  ...
  cssFile.setAttribute('href', '{{ "/openair-cyan/assets/css/just-the-docs-" | absolute_url }}' + theme + '.css');
}
